...
class Requests {
  constructor(id, USER_ID_FROM, title, REQUEST_contents, USER_ID_TO, is_private, stripe_token) {
    this.id = id,
  ...
  (USER_ID_FROM, title, REQUEST_contents, USER_ID_TO, is_private, stripe_token)
  values
  ($1, $2, $3, $4, $5, $6)
  returning id
  `, [USER_ID_FROM, title, REQUEST_contents, USER_ID_TO, is_private, stripe_token])
